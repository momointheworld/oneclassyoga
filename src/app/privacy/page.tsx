...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Privacy Policy | OneClass',
    description:
      'Understand how OneClass collects, uses, and protects your personal information.',
    url: 'https://oneromeo.com/privacy',
    siteName: 'OneClass',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Privacy Policy | OneClass',
    description:
      'Learn how OneClass handles your personal data, payments, and session details securely.',
