          ...
          <div className="flex flex-col justify-between border rounded-xl p-6 shadow text-center">
            <div>
              ...
              <p className="mb-6 text-sm text-gray-700">
                Choose your preferred teacher, pick the perfect date and time,
                and invite up to 5 participants to join. Just ฿250 for each
                additional guest—ideal for friends or family!
              </p>
            </div>
          ...
          <div className="flex flex-col justify-between border rounded-xl p-6 shadow text-center bg-blue-50">
            <div>
              ...
              <p className="mb-6 text-sm text-gray-700">
                ...
                booking single sessions. Ideal for short-term goals or trying
                out different teachers. You&apos;ll coordinate dates and times
